...
export const faq = [
  {
    ...
    answer:
      "Our app discreetly records any device activity in real-time, allowing you to view through their phone all apps, hear calls, and other data through live-streaming technology. It operates in stealth mode, so the person being monitored won't know it's installed.",
  },
  {
    id: "1",
    question: "What type of phones are compatible?",
    answer:
      "It is compatible with most Android devices running version 5.0 or higher, as well as iPhones and iPads using iOS 11.0 or higher.",
  },
  {
    id: "2",
    question: "Is it completely undetectable?",
    answer:
      "Yes, our app runs invisibly on the device, ensuring that your partner or target device user will never know they’re being monitored. It’s designed to operate in stealth mode without leaving any visible traces.",
  },
  {
    id: "3",
    question: "Do I need technical skills to install it?",
    answer:
      "Not at all! The installation process is quick and simple, requiring no special technical knowledge. You can set up the app in just a few minutes and start monitoring immediately.",
  },
  {
    id: "4",
    question: "Do I need my partner's phone?",
    answer:
      "To get started, you’ll first need your own phone to register your account. During the final step of the setup process, you’ll be prompted to add the target phone. Simply take a couple of minutes to access your partner's device, sign in with the same credentials, and you're all set!",
  },
  {
    id: "5",
    question: "What support do you offer if I need help?",
    answer:
      "We provide 24/7 support to ensure you get the help you need anytime. Our dedicated team is available via email and live chat to assist with installation, usage, or any issues you encounter.",
  },
];
...
export const plans = [
  {
    id: "0",
    stripeLink: "https://buy.stripe.com/eVa7vR6N01WC6n6000",
...
<span><strong>24/7 Live Chat Support:</strong> Immediate assistance whenever you need it.</span>,
    ...
    logo: "/images/faq-logo.svg",
  },
  {
    id: "1",
    stripeLink: "https://buy.stripe.com/5kAcQb6N0eJobHqcMN",
    title: "Premium Plan",
    priceMonthly: 29,
    priceYearly: 19,
    caption: "Best for multiple devices",
    features: [
      <span><strong>All Recommended Plan Features</strong></span>,
      <span><strong>Extended Monitoring:</strong> Monitor multiple devices simultaneously.</span>,
      <span><strong>Advanced Alerts:</strong> Customizable notifications for specific activities.</span>,
      <span><strong>Weekly Reports:</strong> Comprehensive summaries of monitored activities.</span>,
      <span><strong>Data Export: </strong> Export monitoring data for analysis or reporting.</span>,
    ],
    icon: "/images/circle.svg",
    logo: "/images/faq-logo.svg",
  },
  {
    id: "2",
    stripeLink: "https://buy.stripe.com/fZedUfgnA6cS26Q8wy",
    title: "Enterprise Plan",
    priceMonthly: 79,
    priceYearly: 59,
    caption: "Exclusively for businesses",
    features: [
      <span><strong>All Premium Plan Features</strong></span>,
      <span><strong>Team Access Control</strong></span>,
      <span><strong>Dedicated Account Manager</strong></span>,
      <span><strong>API Integration</strong></span>,
    ],
    icon: "/images/circle.svg",
    logo: "/images/faq-logo.svg",
  },
...
export const testimonials = [
  {
    ...
    name: "Alysaa",
    role: "Veterinarian",
    avatarUrl: "/images/testimonials/alysaa.jpg",
    comment:
      "After seven months together, I discovered my bf was constantly looking at Shein models.. wtf.",
  },
  {
    id: "1",
    name: "Isabella",
    role: "Personal Trainer",
    avatarUrl: "/images/testimonials/alis.jpg",
    comment:
      "I decided to pay for a month just to see what my boyfriend was up to on his phone after I went to sleep. Turns out, he was spending 2-3 hours scrolling through Pornhub while I was asleep. The world we live in is unreal, please don’t trust anybody, they are all the same",
  },
  {
    id: "2",
    name: "EDDY",
    role: "DDS (Doctor of Dental Surgery)",
    avatarUrl: "/images/testimonials/eddy.jpg",
    comment:
      "the only opposite is that it breaks up many relationships, I caught my gf looking everyday to her ex pics on insta and sending him nudes",
  },
  {
    id: "3",
    name: "Rilind",
    role: "Web Developer",
    avatarUrl: "/images/testimonials/rilind.jpg",
    comment:
      "I thought things were perfect, but then I found out my gf had been browsing instagram influencers for hours every night. The real ones are only your family and old friends, fuck everybody else",
  },
  {
    id: "4",
    name: "Olivia",
    role: "Social Worker",
    avatarUrl: "/images/testimonials/olivia.jpg",
    comment:
      "I’ve seen soo many stories and it’s shocking to realize how many people you trust turn out to be some liars. In my case, I decided to try the first plan and monitored my husband for a week. Thankfully, he didn’t do anything wrong :). I even got my money back after requesting a refund. Huge thanks to the team and best of luck to everyone else out there!! <3 <3",
  },
  {
    id: "5",
    name: "Patrick",
    role: "Warehouse Manager",
    avatarUrl: "/images/testimonials/patrick.jpg",
    comment:
      "I caught my girlfriend searching for Justin Bieber nudes while she wasn’t texting me. It’s hard to get over, esp since we were so close to starting a family together. Can anyone really get over something like this?",
  },
];
